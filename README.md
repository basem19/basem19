...
I’m a results-driven **Front-End Developer** with hands-on experience in building scalable, responsive, and user-centric applications.
I focus on creating seamless digital experiences using **React, TypeScript, Redux Toolkit, Firebase, Tailwind CSS, and modern UI frameworks**.

I’ve built full-featured applications like **e-commerce systems, dashboards, authentication flows, order management tools, and real-time services**.
I value **clean code, performance optimization, and building interfaces that are easy to maintain and scale**.
...
![Formik](https://img.shields.io/badge/Formik-%23007ACC.svg?style=flat\&logo=formik\&logoColor=white)
![Yup](https://img.shields.io/badge/Yup-4B5563?style=flat)
...
<div style="display: flex; align-items: center; margin-bottom: 2em;">
  <img src="https://res.cloudinary.com/dxrceinxi/image/upload/v1744306082/gmserblxtsaq82evmyla.webp" alt="Ecommerce" width="40" style="margin-right: 15px;"/>
...
A **modern, scalable ecommerce system** with seamless shopping experience.
...
![TailwindCSS](https://img.shields.io/badge/tailwindcss-%2338B2AC.svg?style=flat\&logo=tailwind-css\&logoColor=white)
![ShadCN](https://img.shields.io/badge/ShadCN-%23111.svg?style=flat)
![Recharts](https://img.shields.io/badge/Recharts-FF4154?style=flat)
![QZ Tray](https://img.shields.io/badge/QZ%20Tray-333333?style=flat)

Modern food-ordering app with **real-time tracking** and admin tools.
